...
# Workflow
@flow
def main(path: str=r'C:\Users\smart\OneDrive\Desktop\Diamond_MLFLOW\version_1\data\diamonds.csv'):
...
deployment = Deployment.build_from_flow(
    flow=main,
    name="Diamond_Price_Model_Training",
...
main(path=r'C:\Users\smart\OneDrive\Desktop\Diamond_MLFLOW\version_1\data\diamonds.csv')
